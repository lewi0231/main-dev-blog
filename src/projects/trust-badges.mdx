...
- Decide which trust badges are relevant to your store (e.g., SSL certificate, payment security, money-back guarantee).
- Popular badges include PayPal Verified, McAfee Secure, SSL Encrypted, etc.
